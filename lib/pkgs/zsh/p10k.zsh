# Generated by Powerlevel10k configuration wizard on 2022-10-29 at 01:48 BST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%44F'   # green foreground
  ...
  typeset -g POWERLEVEL9K_BATTERY_HIDE_ABOVE_THRESHOLD=95
