  ...
  home-manager.users.atropos.programs.foot = {
    ...
    settings = {
      ...
      colors = {
        ...
        bright2 = "${config.colorScheme.colors.base01}";
        bright3 = "${config.colorScheme.colors.base02}";
        bright4 = "${config.colorScheme.colors.base04}";
        bright5 = "${config.colorScheme.colors.base06}";
        bright6 = "${config.colorScheme.colors.base0F}";
