...
(linuxManualConfig {
  version = "6.7.0-rc1-collabora-rk3588";
  modDirVersion = "6.7.0-rc1";

  src = fetchzip {
    # branch: rk3588
    # date: 2023-07-21
    url = "https://gitlab.collabora.com/hardware-enablement/rockchip-3588/linux/-/archive/v6.7-rc1/linux-v6.7-rc1.zip";
    sha256 = "sha256-s6mX5VLq38ox69BRt8NqvXyLK/s4K9AQuRqBWvcOB6g=";
  };
