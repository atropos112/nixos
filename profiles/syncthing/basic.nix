...
in {
  ...
  start the syncthing service, then copy the keys from .config/syncthing to the secrets path
  and then enable the secrets again. This should also give you the device ID.
  */
  atro = {
    syncthing = {
      enable = true;
